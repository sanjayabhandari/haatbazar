                    ...
                    <div class="panel panel-inverse">
                        ...
                        <div class="panel-body">
                            <table id="data-table" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        <th width="10px" nowrap>ID</th>
                                        <th width="100px" nowrap>NAME</th>
							        <th width="10px" nowrap>IMAGE</th>
										 <th width="2px" nowrap>STATUS</th>
										<th width="10px" nowrap>PRICE</th>
        ...
        <label >status</label>
		  ...
		  <div class="form-group">
            ...
            <div class="kv-avatar " style="width:200px">
		        <input id="avatar-2" name="userImage" type="file" class="file-loading" required>
		    </div>
		  </div>
...
<form  method="post" id="proeditform" >
	...
	<select name="category" id="category" class="form-control action"  required>



			</select>
			<br />
			<select name="subcategory" id="subcategory" class="form-control action"  required>
	...
	<div class="form-group">
		<label >status</label>
		<input type="text" class="form-control" id="pstatus" name="status" >
	</div>
	<div class="form-group">
